...
const Education = () => {
    ...
    return (
        <section id="education" className="min-h-screen py-20 px-6 md:px-20 bg-slate-950">
                ...
                <div className="relative border-l-2 border-slate-800 ml-4 md:ml-8 space-y-12">
                    {timeline.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="bg-slate-900/50 p-6 md:p-8 rounded-xl border border-slate-800 hover:border-blue-500/50 transition-all">
